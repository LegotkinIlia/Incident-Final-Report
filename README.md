...
The goal of this project was to practice creating a professional Incident Final Report based on a simulated real-world security breach. I analyzed an incident involving unauthorized access to customer PII and financial data, documented the incident timeline, investigation findings, response actions, and provided security recommendations.
